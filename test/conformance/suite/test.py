...
test_plan_config = {
    "consent": {},
    "alias": 'sgid-sdk-conformance-test',
...
for module_name in modules.keys():
    ...
    try:
        ...
        if result not in modules[module_name]['expected-result']:
            failed_modules.append(module_name)
            print('[id: {}] Test module {} complete with non-matching results! (State: {}; Result: {}; Expected results: {})\n'.format(module_id, module_name, state, result, modules[module_name]['expected-result']))
        else:
