...
var SgidClient = /** @class */ (function () {
    ...
    function SgidClient(_a) {
        ...
        var Client = new openid_client_1.Issuer({
            issuer: issuer,
            authorization_endpoint: "".concat(hostname, "/v").concat(constants_1.API_VERSION, "/oauth/authorize"),
            token_endpoint: "".concat(hostname, "/v").concat(constants_1.API_VERSION, "/oauth/token"),
            userinfo_endpoint: "".concat(hostname, "/v").concat(constants_1.API_VERSION, "/oauth/userinfo"),
